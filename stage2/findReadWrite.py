...
def findWhereSaved(struct_calls):
    ...
    for c in struct_calls:
        if '01088c80' in str(c):
            instr = currentProgram.getListing().getInstructionAt(c)
            
            found = False
            while not found:
                # print(str(instr))
                if instr.getMnemonicString() == 'MOV':
                    if instr.getDefaultOperandRepresentation(1) == 'RAX':
                        print(str(instr))
                        print(str(instr.getDefaultOperandRepresentation(0)))
                        print(str(instr.getDefaultOperandRepresentation(1)))
                        print
                        found = True
            ...
            while not cleared:
                ...
                if 'RAX' in str(instr.getDefaultOperandRepresentation(0)):
                    print('This is a write to the struct - ' + str(instr))


                if instr.getMnemonicString() == 'MOV':
                    if instr.getDefaultOperandRepresentation(0) == 'RAX':
                        print(str(instr))
                        print(str(instr.getDefaultOperandRepresentation(0)))
                        print(str(instr.getDefaultOperandRepresentation(1)))
                        print
